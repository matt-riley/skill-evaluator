...
1. **Quarantine, don't delete, the feedback guide.** Plan 027 implements
   ...
   > CLI doesn't create or read it yet. The workflow below still works
   > great as a manual note-taking convention. Implementation is tracked
   > in `plans/027-implement-feedback-json.md`.
